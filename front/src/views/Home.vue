        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="clients-grid">
            ...
            <div class="row sorting-container" id="clients-grid-1" data-layout="masonry">
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item ecommerce natural"
              >
                <div class="ui-block">
                    ...
                    <div class="post__author author vcard inline-items">
                      ...
                      <div class="author-date">
                        ...
                        <div class="post__date">
                          <time class="published" datetime="2017-03-24T18:18">19 hours ago</time>
                        </div>
                      </div>
              ...
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item worlds family politics"
              >
                <div class="ui-block">
              ...
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item family animals natural politics"
              >
                <div class="ui-block">
                  <article class="hentry post">
                    <div class="post__author author vcard inline-items">
                      ...
                      <div class="author-date">
                        <a class="h6 post__author-name fn" href="02-ProfilePage.html">James Spiegel</a>
                        <div class="post__date">
                          <time class="published" datetime="2017-03-24T18:18">2 hours ago</time>
                        </div>
                      </div>
                    ...
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempo incididunt ut labore et
                    ...
                    <li>
                      <div class="post__author author vcard inline-items">
                        ...
                        <div class="author-date">
                          ...
                          <div class="post__date">
                            <time class="published" datetime="2017-03-24T18:18">5 mins ago</time>
                          </div>
                        </div>
                    ...
                    <li class="has-children">
                      <div class="post__author author vcard inline-items">
                        ...
                        <div class="author-date">
                          ...
                          <div class="post__date">
                            <time class="published" datetime="2017-03-24T18:18">1 hour ago</time>
                          </div>
                        </div>
                        ...
                        <li>
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="author-date">
                              ...
                              <div class="post__date">
                                <time class="published" datetime="2017-03-24T18:18">39 mins ago</time>
                              </div>
                            </div>
                        ...
                        <li>
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="author-date">
                              ...
                              <div class="post__date">
                                <time class="published" datetime="2017-03-24T18:18">24 mins ago</time>
                              </div>
                            </div>
              ...
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item worlds ecommerce"
              >
                <div class="ui-block">
                      ...
                      <li>
                        <div class="post__author author vcard inline-items">
                          ...
                          <div class="author-date">
                            <a class="h6 post__author-name fn" href="#">Diana Jameson</a>
                            <div class="post__date">
                              <time class="published" datetime="2017-03-24T18:18">16 hours ago</time>
                            </div>
                          </div>
                        </div>
              ...
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item worlds family"
              >
                <div class="ui-block">
                  <article class="hentry post video">
                    <div class="post__author author vcard inline-items">
              ...
              <div
                class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 sorting-item family animals natural"
              >
                <div class="ui-block">
                  <article class="hentry post has-post-thumbnail shared-photo">
                    <div class="post__author author vcard inline-items">
